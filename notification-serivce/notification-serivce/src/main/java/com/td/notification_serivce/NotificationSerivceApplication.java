package com.td.notification_serivce;

import com.td.notification_serivce.config.KafkaConfigs;
import com.td.notification_serivce.kafka.JsonSerializer;
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 1; i <= KafkaConfigs.numEvents; i++) {
				producer.send(new ProducerRecord<>(KafkaConfigs.topicName, i, "Simple Message-" + i));
			}
		}
